  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 p-4">
    <UCard class="max-w-md w-full p-8 shadow-lg">
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-6">How would you rate your experience with us?</p>

        <div class="flex justify-center gap-4">
          <UButton v-for="i in 5" :key="i" variant="outlined" size="lg" class="text-2xl hover:bg-yellow-100 transition"
            @click="onRate(i)">
            ⭐ {{ i }}
          </UButton>
        </div>
